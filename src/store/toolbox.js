...
toolbox += '    </block>'
toolbox += '  </category>'
toolbox += '  <category name="Tiles" colour="#a56d5b">'
toolbox += '    <block type="tile"></block>'
toolbox += '    <block type="random_tile"></block>'
toolbox += '    <block type="get_tile">'
toolbox += '      <value name="TOKEN">'
toolbox += '        <shadow type="current_token">'
toolbox += '        </shadow>'
toolbox += '      </value>'
toolbox += '    </block>'
toolbox += '    <block type="tile_test">'
toolbox += '      <value name="TOKEN">'
toolbox += '        <shadow type="token">'
toolbox += '        </shadow>'
toolbox += '      </value>'
toolbox += '      <value name="TILE">'
toolbox += '        <shadow type="tile">'
toolbox += '        </shadow>'
toolbox += '      </value>'
toolbox += '    </block>'
toolbox += '  </category>'
