...
htmlTemplate += '      },\n'
htmlTemplate += '\n'
htmlTemplate += '      getSector: function (tokenName) {\n'
htmlTemplate += '        for (var key in this.devices){\n'
htmlTemplate += '          if (this.devices[key].id == tokenName){\n'
htmlTemplate += '            return this.devices[key].sector;\n'
htmlTemplate += '          }\n'
htmlTemplate += '        }\n'
htmlTemplate += '        return \'no\';\n'
htmlTemplate += '      },\n'
htmlTemplate += '      setMessage: function (msg, field){\n'
htmlTemplate += '        $(\'#\' + field).html(msg)\n'
htmlTemplate += '      },\n'
htmlTemplate += '      showTextField: function (bool, field) {\n'
htmlTemplate += '        if (bool) {\n'
htmlTemplate += '          $(\'#\' + field).show()\n'
htmlTemplate += '        } else {\n'
htmlTemplate += '          $(\'#\' + field).hide()\n'
htmlTemplate += '        }\n'
htmlTemplate += '      }\n'
htmlTemplate += '\n'
htmlTemplate += '    };\n'
