...
htmlTemplate += '            this.sendPaperSelectCmd(token, app.paperType)\n'
...
htmlTemplate += '          this.sendVibrationCmd(token, 30);\n'
htmlTemplate += '          return;\n'
htmlTemplate += '        }\n'
htmlTemplate += '\n'
...
htmlTemplate += '\n'
htmlTemplate += '        if(app.tokenVal.hasOwnProperty(token.id)) {\n'
htmlTemplate += '          if (!(app.tokenVal[token.id].includes(\'ledoff\'))) {\n'
...
htmlTemplate += '\n'
htmlTemplate += '        if(app.tokenVal.hasOwnProperty(token.id)) {\n'
htmlTemplate += '          if (!(app.tokenVal[token.id].includes(\'displayPattern\'))) {\n'
...
htmlTemplate += '\n'
htmlTemplate += '        if(app.tokenVal.hasOwnProperty(token.id)) {\n'
htmlTemplate += '          if (!(app.tokenVal[token.id].includes(\'displayText\'))) {\n'
...
htmlTemplate += '        var completedFunction = function (data) {\n'
htmlTemplate += '          hyper.log("We happily send the PAPAERSELECT command");\n'
htmlTemplate += '          hyper.log(data)\n'
htmlTemplate += '        };\n'
htmlTemplate += '\n'
htmlTemplate += '        var errorCallback = function (errorMsg) {\n'
htmlTemplate += '          hyper.log("Failed to send the PAPAERSELECT command");\n'
htmlTemplate += '          hyper.log(errorMsg);\n'
htmlTemplate += '        };\n'
htmlTemplate += '\n'
