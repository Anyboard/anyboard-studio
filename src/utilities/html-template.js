...
htmlTemplate += '            if (app.requiredPlayers[0] === null || ((Object.keys(app.devices).length >= app.requiredPlayers[0])\n'
htmlTemplate += '              && (Object.keys(app.devices).length <= app.requiredPlayers[1]))) {\n'
