...
htmlTemplate += '        $("#connected").append(\'<button type="button" class="indicator3">Good to play!</button><br />\');\n'
htmlTemplate += '      },\n'
htmlTemplate += '\n'
...
htmlTemplate += '  <h1 id="title">AnyboardGameDemo</h1>\n'
...
htmlTemplate += '  </div>\n'
htmlTemplate += '\n'
htmlTemplate += '  <div id="textprompt" style="display: none">\n'
htmlTemplate += '    <input type="text" value="Input here!" id="promptField"/>\n'
htmlTemplate += '    <button id="promptButton" onclick="app.getTextPrompt()">OK!</button>\n'
htmlTemplate += '  </div>\n'
htmlTemplate += '</div>\n'
htmlTemplate += '</body>\n'
htmlTemplate += '\n'
